            ...
            <div class="col-lg-8">
                <div class="standard__blog__post">
                    <div class="standard__blog__thumb">
                        <img src="{{asset($blog_id->blog_image)}}" alt="">
                    </div>
                    <div class="blog__details__content services__details__content">
                        <ul class="blog__post__meta">
                            <li><i class="fal fa-calendar-alt"></i> {{$blog_id->created_at}}</li>
                             </ul>
                        <h2 class="title">{!!$blog_id->blog_description!!}</h2>
                        <p>{{$blog_id->blog_title}}</p>
                        </div>
                    <div class="blog__details__bottom">
                        <ul class="blog__details__tag">
                            <li class="title">Tag:</li>
                            <li class="tags-list">
                                <a href="#">{{$blog_id->blog_tags}}</a>
                ...
                <aside class="blog__sidebar">
                        ...
                        <ul class="rc__post">
                            ...
                            <li class="rc__post__item">
                                ...
                                <div class="rc__post__content">
                                    <h5 class="title">{{$all->blog_title}}</h5>
                                    <span class="post-date"><i class="fal fa-calendar-alt"></i> {{$all->created_at}}</span>
                                </div>
                            </li>
                          @endforeach
                    ...
                    <div class="widget">
                       ...
                       @foreach($category as $cat )
                            <li class="sidebar__cat__item"><a href="{{route('category.blog',$cat->id)}}">{{$cat->blog_gategory}}</a></li>
                         @endforeach
