...
<div class="page-content">
     ...
     <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                      <form method = "post" action="{{route ('sorte.profile')}}" enctype="multipart/form-data">
                                    @csrf
                                       <!--view Image-->
                                       <div class="row mb-3">
                                            <label for="example-text-input" class="col-sm-2 col-form-label"></label>
                                            <div class="col-sm-10">
                                            <img id="Showimage" class="rounded avatar-lg" src="{{(!empty($editdata->profile_image))? url('upload/admin_images/'.$editdata->profile_image):url('upload/No_Image_Available.jpg') }}" alt="Card image cap">
                                            </div>
                                        </div>
